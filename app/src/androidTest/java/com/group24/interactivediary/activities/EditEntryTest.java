...
public class EditEntryTest {
    ...
    public void editEntryTest() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.entryCreateTitleEditText),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("private entry"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.entryCreateTextEditText),
                        childAtPosition(
                                ...
                                3),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("contents"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.entryAuthorTextView), withText(testUsername), isDisplayed()));
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.entryCreateTextEditText), withText("contents"),
                        childAtPosition(
                                withId(R.id.entryCreateScrollViewLinearLayout),
                                3),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("contents edited"));

        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.entryCreateTextEditText), withText("contents edited"),
                        childAtPosition(
                                withId(R.id.entryCreateScrollViewLinearLayout),
                                3),
                        isDisplayed()));
        ...
        ViewInteraction textView5 = onView(
                allOf(withId(R.id.entryTextTextView), withText("contents edited"), isDisplayed()));
        textView5.check(matches(withText("contents edited")));
    }
